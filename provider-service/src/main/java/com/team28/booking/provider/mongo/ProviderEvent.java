...
@Document(collection = "provider_events")
public class ProviderEvent implements MongoEvent {
    ...
    public ProviderEvent(String action, LocalDateTime timestamp, Map<String, Object> params) {
        this.action = action;
